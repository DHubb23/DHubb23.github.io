...
* **Key Architecture:** Designed clean, object-oriented logic to process employee check-ins, calculate shift durations dynamically, and store historical logs for management reporting.
---
